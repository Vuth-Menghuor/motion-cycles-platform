...
import checkout_summary from '@/components/cart/checkout_summary.vue'
import Cart_item_card from '@/components/cart/cart_item_card.vue'
import Indecator_process from '@/ui/indecator_process.vue'
